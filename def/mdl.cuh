...
typedef struct {
	...
	//	Optimisation ENCODEUR
	uint         BLOQUES_ENCODEUR;
	uint *      elements_ENCODEUR;
	uint ** instructions_ENCODEUR;

	//	Optimisation DECODEUR
	uint         BLOQUES_DECODEUR;
	uint *      elements_DECODEUR;
	uint ** instructions_DECODEUR;
} Mdl_t;
